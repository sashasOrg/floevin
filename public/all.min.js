angular.module("SashasApp",["ui.router","ngCookies"]),angular.module("SashasApp").config(["$stateProvider","$urlRouterProvider",function(e,t){e.state("home",{url:"/",templateUrl:"./views/home.html",controller:"mainController",access:{restricted:!1}}).state("form",{url:"/form",templateUrl:"./views/form.html",controller:"formController",access:{restricted:!1}}).state("login",{url:"/login",templateUrl:"./views/login.html",controller:"loginController",access:{restricted:!1}}).state("register",{url:"/register",templateUrl:"./views/register.html",controller:"registerController",access:{restricted:!1}}).state("portfolio",{url:"/portfolio",templateUrl:"./views/portfolio.html",controller:"userController",access:{restricted:!1}}).state("stock",{url:"/stock",templateUrl:"./views/stock.html",controller:"mainController",access:{restricted:!1}}).state("admin",{url:"/admin",templateUrl:"/views/admin.html",controller:userController,access:{restricted:!1}}),t.otherwise("/")}]),angular.module("SashasApp").run(["$state","$rootScope","$location","AuthService",function(e,t,r,l){t.$on("$stateChangeStart",function(t,r,o){l.getUserStatus(),r.access.restricted&&!l.isLoggedIn()&&(t.preventDefault(),e.go("login"))})}]);
