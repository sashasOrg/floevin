...
angular.module("SashasApp").controller("formController",["$scope","$cookies","formService",function(n,e,o){n.seachFund="",n.orderByField="",n.reverseSort=!1,n.anyfund=function(){console.log("test"),n.error=!1,n.disabled=!0,o.newFund(n.newfundForm)},n.fundQuery=function(){o.fundQuery(n.searchFund).then(function(e){n.fund=e})},n.getFund=function(){o.getFund().then(function(e){n.fundinfo=e.data})},n.getFund(),n.newFund=function(e,u,t,i,r,d,c,f){o.newFund(e,u,t,i,r,d,c,f).then(function(e){n.getFund()})},n.toggle=function(){n.showing=!n.showing},n.showing=!1}]),angular.module("SashasApp").directive("hideForm",function(){function n(n,e,o){var u=o.hideForm;n.$eval(u)||e.hide(),n.$watch(u,function(n,o){n!==o&&(n?e.stop(!0,!0).slideDown():e.stop(!0,!0).slideUp())})}return{link:n,restrict:"A"}});
