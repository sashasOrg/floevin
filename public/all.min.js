...
angular.module("SashasApp",["ui.router","ngCookies"]),angular.module("SashasApp").config(["$stateProvider","$urlRouterProvider",function(e,t){e.state("home",{url:"/",templateUrl:"./views/home.html",controller:"mainController",access:{restricted:!1}}).state("form",{url:"/form",templateUrl:"./views/form.html",controller:"formController",access:{restricted:!1}}).state("login",{url:"/login",templateUrl:"./views/login.html",controller:"loginController",access:{restricted:!1}}).state("register",{url:"/register",templateUrl:"./views/register.html",controller:"registerController",access:{restricted:!1}}).state("portfolio",{url:"/portfolio",templateUrl:"./views/portfolio.html",controller:"userController",access:{restricted:!1}}).state("stock",{url:"/stock",templateUrl:"./views/stock.html",controller:"mainController",access:{restricted:!1}}).state("fundinfo",{url:"/fundinfo",templateUrl:"/views/fundinfo.html",controller:"formController",access:{restricted:!1}}).state("admin",{url:"/admin",templateUrl:"/views/admin.html",controller:"formController",access:{restricted:!1}}),t.otherwise("/")}]),angular.module("SashasApp").run(["$state","$rootScope","$location","AuthService",function(e,t,r,o){t.$on("$stateChangeStart",function(t,r,l){o.getUserStatus(),r.access.restricted&&!o.isLoggedIn()&&(t.preventDefault(),e.go("login"))})}]);
...
angular.module("SashasApp",["ui.router","ngCookies"]),angular.module("SashasApp").config(["$stateProvider","$urlRouterProvider",function(e,t){e.state("home",{url:"/",templateUrl:"./views/home.html",controller:"mainController",access:{restricted:!1}}).state("form",{url:"/form",templateUrl:"./views/form.html",controller:"formController",access:{restricted:!1}}).state("login",{url:"/login",templateUrl:"./views/login.html",controller:"loginController",access:{restricted:!1}}).state("register",{url:"/register",templateUrl:"./views/register.html",controller:"registerController",access:{restricted:!1}}).state("portfolio",{url:"/portfolio",templateUrl:"./views/portfolio.html",controller:"userController",access:{restricted:!1}}).state("stock",{url:"/stock",templateUrl:"./views/stock.html",controller:"mainController",access:{restricted:!1}}).state("admin",{url:"/admin",templateUrl:"/views/admin.html",controller:"formController",access:{restricted:!1}}),t.otherwise("/")}]),angular.module("SashasApp").run(["$state","$rootScope","$location","AuthService",function(e,t,r,o){t.$on("$stateChangeStart",function(t,r,l){o.getUserStatus(),r.access.restricted&&!o.isLoggedIn()&&(t.preventDefault(),e.go("login"))})}]);
...
angular.module("SashasApp").controller("loginController",["$state","$scope","$location","$cookies","AuthService","mainService",function(o,e,r,n,i,t){e.isLoggedIn=i.isLoggedIn,e.login=function(){e.error=!1,e.disabled=!0,i.login(e.loginForm.username,e.loginForm.password).then(function(r){n.put("currentUser",JSON.stringify(r)),e.disabled=!1,e.loginForm={},i.isLoggedIn(),o.go("portfolio")})["catch"](function(){e.error=!0,e.errorMessage="Invalid username and/or password",e.disabled=!1,e.loginForm={}})}}]),angular.module("SashasApp").controller("logoutController",["$scope","$location","AuthService","mainService",function(o,e,r,n){o.userLogged=r.isLoggedIn(),o.$watch(o.userLogged),o.logout=function(){r.logout().then(function(){n.currentUser={},n.userPageUser={},e.path("login")}),console.log("logout")}}]),angular.module("SashasApp").controller("registerController",["$scope","$location","AuthService",function(o,e,r){o.register=function(){o.error=!1,o.disabled=!0,console.log(o.registerForm),r.register(o.registerForm.username,o.registerForm.password,o.registerForm.firstName,o.registerForm.lastName,o.registerForm.email).then(function(){e.path("login"),o.disabled=!1,o.registerForm={}})["catch"](function(){o.error=!0,o.errorMessage="Something went wrong!",o.disabled=!1,o.registerForm={}})}}]);
angular.module("SashasApp").controller("formController",["$scope","formService",function(n,o){n.anyfund=function(){console.log("test"),n.error=!1,n.disabled=!0,o.newFund(n.newfundForm)},n.getFund=function(){o.getFund().then(function(o){n.fund=o.data})},n.getFund(),n.newFund=function(e,t,u,i,d,r,c,l){o.newFund(e,t,u,i,d,r,c,l).then(function(o){n.getFund()})},n.toggle=function(){n.showing=!n.showing},n.showing=!1}]),angular.module("SashasApp").directive("hideForm",function(){function n(n,o,e){var t=e.hideForm;n.$eval(t)||o.hide(),n.$watch(t,function(n,e){n!==e&&(n?o.stop(!0,!0).slideDown():o.stop(!0,!0).slideUp())})}return{link:n,restrict:"A"}});
angular.module("SashasApp").controller("mainController",["$scope","$state","$cookies","mainService",function(e,a,t,o){e.data=o.data,e.specificData=o.specificData,e.stockQuery="",e.mainService={},e.searchSymbols=function(){o.searchSymbols(e.stockQuery).then(function(e){o.data=e.data.ResultSet.Result,a.reload()})},e.getMoreInformation=function(e){o.getMoreInformation(e).then(function(e){o.specificData=e.data.query.results.quote,console.log(o.specificData),a.reload()})}}]);
angular.module("SashasApp").controller("userController",["$scope","$cookies","mainService",function(e,r,o){e.currentUserCookie=JSON.parse(r.get("currentUser"))}]);
