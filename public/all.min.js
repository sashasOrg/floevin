...
angular.module("SashasApp").controller("formController",["$scope","formService",function(n,e){n.seachFund="",n.orderByField="",n.reverseSort=!1,n.anyfund=function(){console.log("test"),n.error=!1,n.disabled=!0,e.newFund(n.newfundForm)},n.fundQuery=function(){e.fundQuery(n.searchFund).then(function(e){n.fund=e})},n.getFund=function(){e.getFund().then(function(e){n.fundinfo=e.data})},n.getFund(),n.newFund=function(o,u,t,r,d,i,c,f){e.newFund(o,u,t,r,d,i,c,f).then(function(e){n.getFund()})},n.toggle=function(){n.showing=!n.showing},n.showing=!1}]),angular.module("SashasApp").directive("hideForm",function(){function n(n,e,o){var u=o.hideForm;n.$eval(u)||e.hide(),n.$watch(u,function(n,o){n!==o&&(n?e.stop(!0,!0).slideDown():e.stop(!0,!0).slideUp())})}return{link:n,restrict:"A"}});
