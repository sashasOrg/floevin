angular.module("SashasApp",["ui.router","ngCookies"]),angular.module("SashasApp").config(["$stateProvider","$urlRouterProvider",function(e,t){e.state("home",{url:"/",templateUrl:"./views/home.html",controller:"mainController",access:{restricted:!1}}).state("form",{url:"/form",templateUrl:"./views/form.html",controller:"formController",access:{restricted:!1}}).state("login",{url:"/login",templateUrl:"./views/login.html",controller:"loginController",access:{restricted:!1}}).state("register",{url:"/register",templateUrl:"./views/register.html",controller:"registerController",access:{restricted:!1}}).state("portfolio",{url:"/portfolio",templateUrl:"./views/portfolio.html",controller:"userController",access:{restricted:!1}}).state("stock",{url:"/stock",templateUrl:"./views/stock.html",controller:"mainController",access:{restricted:!1}}).state("fund",{url:"/fund",templateUrl:"/views/fund.html",controller:"formController",access:{restricted:!1}}).state("admin",{url:"/admin",templateUrl:"/views/admin.html",controller:"formController",access:{restricted:!1}}),t.otherwise("/")}]),angular.module("SashasApp").run(["$state","$rootScope","$location","AuthService",function(e,t,r,l){t.$on("$stateChangeStart",function(t,r,o){l.getUserStatus(),r.access.restricted&&!l.isLoggedIn()&&(t.preventDefault(),e.go("login"))})}]);
...
angular.module("SashasApp").controller("formController",["$scope","formService",function(n,o){n.fund=data,n.anyfund=function(){console.log("test"),n.error=!1,n.disabled=!0,o.newFund(n.newfundForm)},n.getFund=function(){o.getFund().then(function(o){n.fund=o.data})},n.getFund(),n.newFund=function(e,t,u,i,d,r,a,c){o.newFund(e,t,u,i,d,r,a,c).then(function(o){n.getFund()})},n.toggle=function(){n.showing=!n.showing},n.showing=!1}]),angular.module("SashasApp").directive("hideForm",function(){function n(n,o,e){var t=e.hideForm;n.$eval(t)||o.hide(),n.$watch(t,function(n,e){n!==e&&(n?o.stop(!0,!0).slideDown():o.stop(!0,!0).slideUp())})}return{link:n,restrict:"A"}});
